...
def publications_category_types_get():  # noqa: E501
    ...
    :rtype: ApiOptions
    """
    return rc.publications_category_types_get()
...
def publications_get(search=None, offset=None, limit=None):  # noqa: E501
    ...
    """
    return rc.publications_get(search, offset, limit)
...
def publications_uuid_delete(uuid):  # noqa: E501
    ...
    :rtype: Status200OkNoContent
    """
    return rc.publications_uuid_delete(uuid)
...
def publications_uuid_get(uuid):  # noqa: E501
    ...
    :rtype: Status200OkNoContent
    """
    return rc.publications_uuid_get(uuid)
...
def publications_uuid_patch(uuid):  # noqa: E501
    ...
    :rtype: Status200OkNoContent
    """
    return rc.publications_uuid_patch(uuid)
