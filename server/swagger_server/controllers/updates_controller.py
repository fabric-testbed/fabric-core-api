...
def updates_post(body=None):  # noqa: E501
    ...
    if connexion.request.is_json:
        body = FacilityUpdatePost.from_dict(connexion.request.get_json())  # noqa: E501
    return rc.updates_post(body)
...
def updates_uuid_delete(uuid):  # noqa: E501
    ...
    """
    return rc.updates_uuid_delete(uuid)
...
def updates_uuid_get(uuid):  # noqa: E501
    ...
    :rtype: Updates
    """
    return rc.updates_uuid_get(uuid)
...
def updates_uuid_patch(uuid, body=None):  # noqa: E501
    ...
    """
    if connexion.request.is_json:
        body = FacilityUpdatePatch.from_dict(connexion.request.get_json())  # noqa: E501
    return rc.updates_uuid_patch(uuid, body)
