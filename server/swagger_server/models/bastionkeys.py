...
from swagger_server.models.bastionkeys_one import BastionkeysOne  # noqa: F401,E501
from swagger_server.models.status200_ok_single import Status200OkSingle  # noqa: F401,E501
from swagger_server import util


class Bastionkeys(Model):
    ...
    def __init__(self, results: List[BastionkeysOne]=None, size: int=1, status: int=200, type: str=None):  # noqa: E501
        ...
        :type status: int
        :param type: The type of this Bastionkeys.  # noqa: E501
        :type type: str
        """
        self.swagger_types = {
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'Bastionkeys':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The bastionkeys of this Bastionkeys.  # noqa: E501
        :rtype: Bastionkeys
        """
    ...
    @property
    def size(self) -> int:
        """Gets the size of this Bastionkeys.


        :return: The size of this Bastionkeys.
        :rtype: int
        """
        return self._size
    ...
    def size(self, size: int):
        """Sets the size of this Bastionkeys.


        :param size: The size of this Bastionkeys.
        :type size: int
        """
    ...
    @property
    def status(self) -> int:
        """Gets the status of this Bastionkeys.


        :return: The status of this Bastionkeys.
        :rtype: int
        """
        return self._status
    ...
    def status(self, status: int):
        """Sets the status of this Bastionkeys.


        :param status: The status of this Bastionkeys.
        :type status: int
        """
    ...
    @property
    def type(self) -> str:
        """Gets the type of this Bastionkeys.


        :return: The type of this Bastionkeys.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type: str):
        """Sets the type of this Bastionkeys.


        :param type: The type of this Bastionkeys.
        :type type: str
        """
