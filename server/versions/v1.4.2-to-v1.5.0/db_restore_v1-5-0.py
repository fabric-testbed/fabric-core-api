...
Changes from v1.4.2 --> v1.5.0
 public | projects                  | table | postgres
 - add: project_storage = db.relationship('FabricStorage', secondary=projects_storage)

 public | user_org_affiliations     | table | postgres
 - new table - no import required
